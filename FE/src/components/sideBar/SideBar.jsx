...
export default function SideBar() {
    ...
    return (
      <div className={classes.sideBarContainer}>
        ...
        >
          <div
            className={`${classes.bar} ${isOpen ? classes.open1 : ""}`}
          ></div>
          <div
            className={`${classes.bar} ${isOpen ? classes.open2 : ""}`}
          ></div>
          <div
            className={`${classes.bar} ${isOpen ? classes.open3 : ""}`}
          ></div>
        </button>

        {/* תפריט הצד שנשלף מימין */}
        <nav
          className={`${classes.sidebarNav} ${isOpen ? classes.active : ""}`}
        >
